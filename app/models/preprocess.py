...
from app.config.data_config import MAX_SEQUENCE_LENGTH, TEST_SIZE, VALIDATION_SIZE, DATASET_PATH, X_TEST_PATH, X_TRAIN_PATH, X_VAL_PATH, Y_TEST_PATH, Y_TRAIN_PATH, Y_VAL_PATH, DATA_DIR
...
def preprocess_data(input_file_path):
    ...
    np.save(os.path.join(DATA_DIR, "pos_to_numerical.npy"), pos_to_numerical)
